...
@NamedQueries({
    ...
    , @NamedQuery(name = "Audiences.findByHeureAud", query = "SELECT a FROM Audiences a WHERE a.heureAud = :heureAud")
...
public class Audiences implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "Heure_Aud", nullable = false)
    @Temporal(TemporalType.TIME)
    private Date heureAud;
    @Basic(optional = false)
    @Column(name = "Statut_Aud", nullable = false, length = 20)
    private String statutAud;
    @Basic(optional = false)
    @Lob
    @Column(name = "Comm_Aud", nullable = false, length = 2147483647)
    ...
    public Audiences(Integer idAud, Date dateAud, Date heureAud, String statutAud, String commAud) {
        this.idAud = idAud;
        this.dateAud = dateAud;
        this.heureAud = heureAud;
    ...
    public Date getHeureAud() {
        return heureAud;
    }

    public void setHeureAud(Date heureAud) {
        this.heureAud = heureAud;
    }
